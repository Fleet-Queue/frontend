...
import { addTruck, editTruck, getAllCompany, getCompanyDrivers } from 'utils/Service';
                  ...
                  >
                    ...
                    {companies.map((data) => (
                      <MenuItem key={data._id} value={data._id}>
                        {data.name} Mob: {data.contactNumber} Address: {data.address}{' '}
                      </MenuItem>
                    ))}
                  </Select>
                )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <>
                  ...
                  {errors.name && <span style={{ color: '#f00' }}>{errors.name.message}</span>}
                </>
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <>
                  ...
                  {errors.registrationNumber && <span style={{ color: '#f00' }}>{errors.registrationNumber.message}</span>}
                </>
              )}
              rules={{ required: 'Reg No is required' }}
            />

            <FormControl error={Boolean(errors.driverId)} disabled={!companyId}>
